...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    highlight: "Hourly refreshes + one-click predictive AI.",
    features: [
      "Up to 5 data sources",
      "500,000 row warehouse cap",
      "Hourly automated refreshes",
      "🔓 One-Click Predictive Analytics (BQML)",
  ...
  },
  {
    ...
    highlight: "Dedicated BigQuery slots, custom SLAs.",
    features: [
      "Custom warehouse scaling",
      "Dedicated BigQuery slot reservations",
