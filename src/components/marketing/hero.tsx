...
// Long continuous ECG zigzag — used by both the static base path and the
// travelling pulse path so the bright segment traces the same shape.
const ECG_PATH =
...
export function MarketingHero() {
  return (
    <section className="relative overflow-hidden pt-28 pb-24 sm:pt-32 sm:pb-32 lg:flex lg:min-h-[88vh] lg:items-center">
      {/* ECG line sits behind the headline (vertical centre of the section).
          Two paths: a static faint base + a travelling bright pulse.
          Edge fades stop it from clipping abruptly at viewport edges. */}
      <svg
      ...
      <div className="container-page w-full">
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,_1.5fr)_minmax(0,_360px)] lg:gap-20">
          {/* Left — copy & CTAs */}
          ...
          {/* Right — compact stat cards, top-aligned on lg+ via items-center on grid */}
