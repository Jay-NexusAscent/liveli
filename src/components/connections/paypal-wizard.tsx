...
export function PaypalWizard({ open, onClose, onConnected }: PaypalWizardProps) {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const res = await fetch("/api/connections/paypal/connect", {
        method: "POST",
  ...
  return (
    <Modal open={open} onClose={onClose} title="Connect PayPal" maxWidth="max-w-lg">
      <form onSubmit={submit} className="space-y-4">
        ...
        <Field
          label="Client ID"
          hint="PayPal Developer Dashboard → My Apps & Credentials → your REST app."
        >
          <input
            type="text"
            required
